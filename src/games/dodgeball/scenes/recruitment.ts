...
export class Recruitment extends Phaser.Scene {
    ...
    create():void {
        ...
        let player1 = new RecruitedPlayer(this, 100, 100, 'player');
        let player2 = new RecruitedPlayer(this, 200, 200, 'player');
        let player3 = new RecruitedPlayer(this, 300, 300, 'player');
